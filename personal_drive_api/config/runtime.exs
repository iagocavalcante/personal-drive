...
#
#     PHX_SERVER=true bin/personal_drive_api start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :personal_drive_api, PersonalDriveApiWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/personal_drive_api/personal_drive_api.db
      """
  ...
  config :personal_drive_api, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :personal_drive_api, PersonalDriveApi.Mailer,
